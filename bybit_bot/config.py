...
# potential = f(consensus, strength) trong [0,1].
CAPITAL_PCT_MIN = 0.10   # HF: 10% equity moi lenh toi thieu
CAPITAL_PCT_MAX = 0.90   # HF: toi da 90% equity/lenh - lenh chac chan loi
MAX_CAPITAL_PCT = 0.90   # HF: tran mem = CAPITAL_PCT_MAX
