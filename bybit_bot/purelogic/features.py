...
def build(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for period, mult in ((20, 2.0), (10, 1.5), (50, 2.5)):
        ...
        tag = f"{period}_{mult:g}"
        out[f"bb_pctb_{tag}"] = pct_b
        out[f"bb_width_{tag}"] = width
    ...
    out["dom"] = dt.dt.day.astype(float)
...
FEATURE_COLUMNS: list[str] = (
    ...
    + ["cci14", "cci20"]
    + ["bb_pctb_20_2", "bb_width_20_2", "bb_pctb_10_1.5",
       "bb_width_10_1.5", "bb_pctb_50_2.5", "bb_width_50_2.5"]
    ...
    + ["body_pct", "upper_wick_pct", "lower_wick_pct", "range_pct"]
    + ["consec_streak", "hour", "dow", "dom", "is_asia", "is_eu", "is_us"]
)
