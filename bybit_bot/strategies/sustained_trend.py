...
class SustainedTrendStrategy(BaseStrategy):
    ...
    def __init__(self, slope_bars=20, rsi_oversold=30, rsi_overbought=70):
    ...
    def generate_signal(self, df: pd.DataFrame, df_trend: pd.DataFrame, df_macro: pd.DataFrame) -> Signal:
        ...
        rsi_mid    = 30 < rsi < 70   # Dong bo 30/70 voi main.py reversal routing (cu: 35/65)
        ...
        rsi_mid_up = 30 < rsi < 70   # Dong bo voi rsi_mid ben tren
